...
var AddGame = /** @class */ (function (_super) {
    ...
    function AddGame(props) {
        ...
        _this.state = { title: "", loading: true, GameData: new FetchGame_1.GameData, path: null ? "data:image/png;base64," : "data:image/png;base64," };
        ...
        // This will set state for Add employee
            ...
            _this.state = { title: "Create", loading: false, GameData: new FetchGame_1.GameData, path: null ? "data:image/png;base64," : "data:image/png;base64," };
        }
